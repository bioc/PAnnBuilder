...
which are freely available for download from {\url{http://www.biosino.org/PAnnBuilder/example.jsp}}.
...
\subsection{Change}
PAnnBuilder 1.3.0 builds environment-based and SQLite-based annotation packages.
PAnnBuilder 1.4.0 only builds SQLite-based annotation packages to accord with Bioconductor standard annotation packages.

\subsection{Installation}
To install PAnnBuilder, user can use the installation script "PAnnBuilder.R" to 
download the newest version and install it in R.
<<install>>=
biocLite("PAnnBuilder")
library(PAnnBuilder)
@
Note: Web Connection is needed to install PAnnBuilder and its depended packages.
All the codes in this vignette were tested in R 2.8.0 and 2.9.0, thus latest R 
is recommended.
...
These pre-built package can be downloaded via 
{\url{http://www.biosino.org/PAnnBuilder/example.jsp}}.
...
enviroment based package "org.Hs.ipi", or SQLite based package "org.Hs.ipi.db". 
...
\begin{table}
\footnotesize
\caption{\label{table:packages1}Enviroment-based Annotation Packges Produced by PAnnBuilder.}
...
\multirow{9}{0.2\textwidth}{pBaseBuilder} &
 \multirow{3}{0.11\textwidth}{IPI} & 
  Homo sapiens & org.Hs.ipi &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ipi_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ipi_1.0.0.tar.gz}{Unix} \\
  & & & Mus musculus & org.Mm.ipi &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ipi_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ipi_1.0.0.tar.gz}{Unix} \\ 
  & & & Rattus norvegicus & org.Rn.ipi &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ipi_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ipi_1.0.0.tar.gz}{Unix} \\ 
 & & \multirow{3}{0.15\textwidth}{Swiss-Prot} & 
  Homo sapiens & org.Hs.sp &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.sp_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.sp_1.0.0.tar.gz}{Unix} \\
  & & & Mus musculus & org.Mm.sp &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.sp_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.sp_1.0.0.tar.gz}{Unix} \\
  & & & Rattus norvegicus & org.Rn.sp &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.sp_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.sp_1.0.0.tar.gz}{Unix} \\ 
 & & \multirow{3}{0.15\textwidth}{RefSeq} & 
  Homo sapiens & org.Hs.ref &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ref_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ref_1.0.0.tar.gz}{Unix} \\
  & & & Mus musculus & org.Mm.ref &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ref_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ref_1.0.0.tar.gz}{Unix} \\
  & & & Rattus norvegicus & org.Rn.ref &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ref_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ref_1.0.0.tar.gz}{Unix} \\ \hline 
\multirow{3}{0.25\textwidth}{protein indentifier mapping} & 
\multirow{3}{0.2\textwidth}{crossBuilder} & 
\multirow{3}{0.11\textwidth}{Swiss-Prot, IPI, RefSeq} & 
  Homo sapiens & org.Hs.cross &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.cross_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.cross_1.0.0.tar.gz}{Unix} \\
  & & &  Mus musculus & org.Mm.cross &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.cross_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.cross_1.0.0.tar.gz}{Unix} \\
  & & & Rattus norvegicus & org.Rn.cross &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.cross_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.cross_1.0.0.tar.gz}{Unix} \\ \hline 
\multirow{5}{0.25\textwidth}{protein-protein or domain-domain interaction data} & 
\multirow{5}{0.2\textwidth}{intBuilder}  
 & IntAct & & int.intact &
  \href{http://www.biosino.org/download/PAnnBuilder/int.intact_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.intact_1.0.0.tar.gz}{Unix} \\
 & & NCBI Gene & & int.geneint &
  \href{http://www.biosino.org/download/PAnnBuilder/int.geneint_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.geneint_1.0.0.tar.gz}{Unix} \\
 & & MPPI & & int.mppi &
  \href{http://www.biosino.org/download/PAnnBuilder/int.mppi_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.mppi_1.0.0.tar.gz}{Unix} \\
 & & 3did & & int.did &
  \href{http://www.biosino.org/download/PAnnBuilder/int.did_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.did_1.0.0.tar.gz}{Unix} \\
 & & Domine & & int.domine &
  \href{http://www.biosino.org/download/PAnnBuilder/int.domine_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.domine_1.0.0.tar.gz}{Unix} \\ \hline
\multirow{2}{0.25\textwidth}{protein subcell location} &
\multirow{2}{0.2\textwidth}{subcellBuilder} 
 & BaCelLo & & sc.bacello &
  \href{http://www.biosino.org/download/PAnnBuilder/sc.bacello_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/sc.bacello_1.0.0.tar.gz}{Unix} \\
 & & DBSubLoc & & sc.dbsubloc &
  \href{http://www.biosino.org/download/PAnnBuilder/sc.dbsubloc_1.0.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/sc.dbsubloc_1.0.0.tar.gz}{Unix} \\ \hline
protein structure classification & scopBuilder & SCOP & 
 & scop &
 \href{http://www.biosino.org/download/PAnnBuilder/scop_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/scop_1.0.0.tar.gz}{Unix} \\ \hline
protein post-translational modification & ptmBuilder & SysPTM &
 & sysptm &
 \href{http://www.biosino.org/download/PAnnBuilder/sysptm_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/sysptm_1.0.0.tar.gz}{Unix} \\ \hline
body fluid protein & bfBuilder & Sys-BodyFluid & Homo sapiens
 & org.Hs.bf &
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.bf_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.bf_1.0.0.tar.gz}{Unix} \\ \hline
homolog protein group & HomoloGeneBuilder & HomoloGene
 & & homolog &
 \href{http://www.biosino.org/download/PAnnBuilder/homolog_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/homolog_1.0.0.tar.gz}{Unix} \\ \hline
ortholog protein group & InParanoidBuilder & InParanoid
 & Homo sapiens, Mus musculus & org.HsMm.ortholog &
 \href{http://www.biosino.org/download/PAnnBuilder/org.HsMm.ortholog_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.HsMm.ortholog_1.0.0.tar.gz}{Unix} \\ \hline
peptides identified by mass spectrometry & PeptideAtlasBuilder
 & PeptideAtlas & Homo sapiens & org.Hs.pep &
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.pep_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.pep_1.0.0.tar.gz}{Unix} \\ \hline
gene ontology & GOABuilder & GOA & Homo sapiens & org.Hs.goa &
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.goa_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.goa_1.0.0.tar.gz}{Unix} \\ \hline
identifier and name & dNameBuilder & & & dName & 
 \href{http://www.biosino.org/download/PAnnBuilder/dName_1.0.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/dName_1.0.0.tar.gz}{Unix} \\ \hline
\end{tabular}
\end{table}
...
\multirow{9}{0.2\textwidth}{pBaseBuilder\_DB} &
 \multirow{3}{0.15\textwidth}{IPI} & 
  ...
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ipi.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ipi.db_1.1.0.tar.gz}{Unix} \\
  & & & Mus musculus & org.Mm.ipi.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ipi.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ipi.db_1.1.0.tar.gz}{Unix} \\ 
  & & & Rattus norvegicus & org.Rn.ipi.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ipi.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ipi.db_1.1.0.tar.gz}{Unix} \\ 
 & & \multirow{3}{0.15\textwidth}{Swiss-Prot} & 
  Homo sapiens & org.Hs.sp.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.sp.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.sp.db_1.1.0.tar.gz}{Unix} \\
  & & & Mus musculus & org.Mm.sp.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.sp.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.sp.db_1.1.0.tar.gz}{Unix} \\
  & & & Rattus norvegicus & org.Rn.sp.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.sp.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.sp.db_1.1.0.tar.gz}{Unix} \\ 
 & & \multirow{3}{0.15\textwidth}{RefSeq} & 
  Homo sapiens & org.Hs.ref.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ref.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.ref.db_1.1.0.tar.gz}{Unix} \\
  & & & Mus musculus & org.Mm.ref.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ref.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.ref.db_1.1.0.tar.gz}{Unix} \\
  & & & Rattus norvegicus & org.Rn.ref.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ref.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.ref.db_1.1.0.tar.gz}{Unix} \\ \hline 
\multirow{3}{0.25\textwidth}{protein indentifier mapping} & 
\multirow{3}{0.2\textwidth}{crossBuilder\_DB} & 
\multirow{3}{0.15\textwidth}{Swiss-Prot, IPI, RefSeq} & 
  Homo sapiens & org.Hs.cross.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.cross.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.cross.db_1.1.0.tar.gz}{Unix} \\
  & & &  Mus musculus & org.Mm.cross.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.cross.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Mm.cross.db_1.1.0.tar.gz}{Unix} \\
  & & & Rattus norvegicus & org.Rn.cross.db &
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.cross.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/org.Rn.cross.db_1.1.0.tar.gz}{Unix} \\ \hline 
\multirow{5}{0.25\textwidth}{protein-protein or domain-domain interaction data} & 
\multirow{5}{0.2\textwidth}{intBuilder\_DB}  
 & IntAct & & int.intact.db &
  \href{http://www.biosino.org/download/PAnnBuilder/int.intact.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.intact.db_1.1.0.tar.gz}{Unix} \\
 & & NCBI Gene & & int.geneint.db &
  \href{http://www.biosino.org/download/PAnnBuilder/int.geneint.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.geneint.db_1.1.0.tar.gz}{Unix} \\
 & & MPPI & & int.mppi.db &
  \href{http://www.biosino.org/download/PAnnBuilder/int.mppi.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.mppi.db_1.1.0.tar.gz}{Unix} \\
 & & 3did & & int.did.db &
  \href{http://www.biosino.org/download/PAnnBuilder/int.did.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.did.db_1.1.0.tar.gz}{Unix} \\
 & & Domine & & int.domine.db &
  \href{http://www.biosino.org/download/PAnnBuilder/int.domine.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/int.domine.db_1.1.0.tar.gz}{Unix} \\ \hline
\multirow{2}{0.25\textwidth}{protein subcell location} &
\multirow{2}{0.2\textwidth}{subcellBuilder\_DB} 
 & BaCelLo & & sc.bacello.db &
  \href{http://www.biosino.org/download/PAnnBuilder/sc.bacello.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/sc.bacello.db_1.1.0.tar.gz}{Unix} \\
 & & DBSubLoc & & sc.dbsubloc.db &
  \href{http://www.biosino.org/download/PAnnBuilder/sc.dbsubloc.db_1.1.0.zip}{Window} ; 
  \href{http://www.biosino.org/download/PAnnBuilder/sc.dbsubloc.db_1.1.0.tar.gz}{Unix} \\ \hline
protein structure classification & scopBuilder\_DB & SCOP & 
 & scop.db &
 \href{http://www.biosino.org/download/PAnnBuilder/scop.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/scop.db_1.1.0.tar.gz}{Unix} \\ \hline
protein post-translational modification & ptmBuilder\_DB & SysPTM &
 & sysptm.db &
 \href{http://www.biosino.org/download/PAnnBuilder/sysptm.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/sysptm.db_1.1.0.tar.gz}{Unix} \\ \hline
body fluid protein & bfBuilder\_DB & Sys-BodyFluid & Homo sapiens
 & org.Hs.bf.db &
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.bf.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.bf.db_1.1.0.tar.gz}{Unix} \\ \hline
homolog protein group & HomoloGeneBuilder\_DB & HomoloGene
 & & homolog.db &
 \href{http://www.biosino.org/download/PAnnBuilder/homolog.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/homolog.db_1.1.0.tar.gz}{Unix} \\ \hline
ortholog protein group & InParanoidBuilder\_DB & InParanoid
 & Homo sapiens, Mus musculus & org.HsMm.ortholog.db &
 \href{http://www.biosino.org/download/PAnnBuilder/org.HsMm.ortholog.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.HsMm.ortholog.db_1.1.0.tar.gz}{Unix} \\ \hline
peptides identified by mass spectrometry & PeptideAtlasBuilder\_DB
 & PeptideAtlas & Homo sapiens & org.Hs.pep.db &
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.pep.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.pep.db_1.1.0.tar.gz}{Unix} \\ \hline
gene ontology & GOABuilder\_DB & GOA & Homo sapiens & org.Hs.goa.db &
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.goa.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/org.Hs.goa.db_1.1.0.tar.gz}{Unix} \\ \hline
identifier and name & dNameBuilder\_DB & & & dName.db & 
 \href{http://www.biosino.org/download/PAnnBuilder/dName.db_1.1.0.zip}{Window} ; 
 \href{http://www.biosino.org/download/PAnnBuilder/dName.db_1.1.0.tar.gz}{Unix} \\ \hline
\end{tabular}
\end{center}
\end{table}

\subsubsection{Using annotation data package}
The general way of using enviroment-based annotation data package is the following:
\begin{enumerate}
...
if( .Platform$OS.type == "windows" ){
  ...
  tmpFile <- paste("http://www.biosino.org/download/PAnnBuilder",
             "org.Hs.ipi.db_1.1.0.tar.gz", sep="/")
  tmpPath <- file.path(tempdir(),"org.Hs.ipi.db_1.1.0.tar.gz")
}
...
For SQLite-based *.db packages, more flexible data query, reverse mapping, and 
data filtering and can be performed. Vignette of "AnnotationDbi" detailedly described 
how to use SQLite based packages ({\url{http://www.bioconductor.org/packages/release/bioc/vignettes/AnnotationDbi/inst/doc/AnnotationDbi.pdf}}). 
...
if( .Platform$OS.type == "windows" ){
  ## For Windows users, please use *.zip package:
  tmpFile <- paste("http://www.biosino.org/download/PAnnBuilder",
             "org.Hs.ipi.db_1.1.0.zip",sep="/")
  tmpPath <- file.path(tempdir(),"org.Hs.ipi.db_1.1.0.zip") 
}else{
  ## For Unix users, please use *.tar.gz package:
  tmpFile <- paste("http://www.biosino.org/download/PAnnBuilder",
             "org.Hs.ipi.db_1.1.0.tar.gz",sep="/")
...
\item \Rfunction{getRepList} - return a list which will replace the symbols in 
 template file.
\item \Rfunction{copyTemplates} - will produce a "*.rd" file in the "man" 
...
\item \Rfunction{copyTemplates\_DB} - implement similar function with 
 ...
 annotation package. 
\item \Rfunction{writeDescription} - write descrption file for the package.
...
to assemble proteomic annotaion data. Each function is implemented by two 
R functions: "*Builder" for R-environment based package and "*Builder\_DB" for SQLite
based package.
\begin{itemize}
\item \Rfunction{pBaseBuilder}, \Rfunction{pBaseBuilder\_DB} - build annotation 
 data packages for primary protein database such as SwissProt, TREMBL, IPI or 
 NCBI RefSeq protein data. 
\item \Rfunction{pSeqBuilder}, \Rfunction{pSeqBuilder\_DB} - build annotation
 data packages for query protein sequences based on sequence similarity.
\item \Rfunction{crossBuilder}, \Rfunction{crossBuilder\_DB} - build annotation
 data packages for protein id mapping in SwissProt, Trembl, IPI and NCBI Refseq
 databases. 
\item \Rfunction{subcellBuilder}, \Rfunction{subcellBuilder\_DB} - build 
 annotation data packages for protein subcellular location from BaCelLo or 
 DBSubLoc database.
\item \Rfunction{HomoloGeneBuilder}, \Rfunction{HomoloGeneBuilder\_DB} - build 
 annotation data packages for homolog protein group from NCBI HomoloGene database.
\item \Rfunction{InParanoidBuilder}, \Rfunction{InParanoidBuilder\_DB} - build
 annotation data packages for ortholog protein group between two given organisms
 from InParanoid database.
\item \Rfunction{GOABuilder}, \Rfunction{GOABuilder\_DB} - build annotation data
 packages for mapping proteins of UniProt to Gene Ontolgy from GOA database.
\item \Rfunction{scopBuilder}, \Rfunction{scopBuilder\_DB} - build annotation
 data packages for Structural Classification of Proteins.
\item \Rfunction{intBuilder}, \Rfunction{intBuilder\_DB} - build annotation data
 packages for protein-protein or domain-domain interaction from IntAct, MPPI, 
 3DID, DOMINE or NCBI Gene interaction database.
\item \Rfunction{PeptideAtlasBuilder}, \Rfunction{PeptideAtlasBuilder\_DB} - 
 build annotation data packages for experimentally identified peptides from 
 PeptideAtlas database.
\item \Rfunction{ptmBuilder}, \Rfunction{ptmBuilder\_DB} - build annotation data
 packages for post-translational modifications from SysPTM database.
\item \Rfunction{bfBuilder}, \Rfunction{bfBuilder\_DB} - build annotation data
 packages for proteins in body fluids from SysBodyFluid database.
\item \Rfunction{dNameBuilder}, \Rfunction{dNameBuilder\_DB} - build annotation
...
\Rpackage{org.Hs.ipi.db}, can be downloaded from
http://www.biosino.org/PAnnBuilder/example.jsp and installed on Unix or Windows.
...
if( !require("org.Hs.sp.db") ){
  if( .Platform$OS.type == "windows" ){
    ## For Windows users, please use *.zip package:
    tmpFile <- paste("http://www.biosino.org/download/PAnnBuilder",
               "org.Hs.sp.db_1.1.0.zip",sep="/")
    tmpPath <- file.path(tempdir(),"org.Hs.sp.db_1.1.0.zip") 
  }else{
    ## For Unix users, please use *.tar.gz package:
    tmpFile <- paste("http://www.biosino.org/download/PAnnBuilder",
               "org.Hs.sp.db_1.1.0.tar.gz",sep="/")
    tmpPath <- file.path(tempdir(),"org.Hs.sp.db_1.1.0.tar.gz")
  }
  download.file(tmpFile, tmpPath) 
  install.packages(tmpPath,repos = NULL) 
}
